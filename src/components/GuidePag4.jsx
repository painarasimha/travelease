  ...
  return (
    <div className="h-screen bg-cover bg-no-repeat bg-center py-14 px-[130px]" style={{ backgroundImage: `url(${Img2})` }}>
        ...
        <div className='absolute inset-0 flex py-48 px-52'>
            <img src={GuideProfile4} alt="guide1profile" className='w-48 h-48 fixed rounded-full border-4 border-black object-cover'/>
            <h1 className="text-2xl font-black fixed text-black mt-52 ml-6">{firstName} {lastName}</h1>
