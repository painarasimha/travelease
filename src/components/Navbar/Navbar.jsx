...
const Navbar = () => {
  ...
  return (
    <nav className="bg-[#0b1f32] text-[#fff] font-bold flex justify-between items-center px-10 py-5">
      ...
      <ul className="flex items-center space-x-4">
        ...
        <li>
          <a href="#" className="hover:text-gray-400">Travel Guide</a>
        </li>
        <li>
        ...
        <li>
          <a href="#" className="hover:text-gray-400">
            <svg class="h-8 w-8 text-[#fdfdff]-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
